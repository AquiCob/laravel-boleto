...
abstract class AbstractBoleto implements BoletoContract
{
    ...
    {
        return $this->pixPayload;
    }

    /**
     * @param null $pixPayload
     */
    public function setPixPayload($pixPayload): void
    {
    ...
    {
        return realpath(__DIR__ . '/../../logos/logo_pix.png');
    }
